...
| Teszt #05 | Eredmény kiíratása (=) | A műveleti állapotban a művelet végrehajtódik, ellenkező esetben a memória az első bevitt szám lesz. | Művelet  végrehajtódik. Műveleti állapotban a felső szövegdobozban megjelenik a művelet értéke, más esetben az alsó szövegdoboz értéke elmentődik a memóriába, és kiiratódik felül | Nem találtam problémát.|
| Teszt #06 | Negáló gomb (+/-) megnyomása | Alsó szövegdobozban megjelenik/eltűnik az előjel. | Művelet végrehajtódik. Alsó szövegdobozban megjelent/eltűnt az előjel, nulla esetén nem változik az előjel. | Nem követi a művelet végrehajtást! Prioritás: alacsony  |
