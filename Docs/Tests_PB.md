...
| Teszt #05 | Eredmény kiíratása (=) | A műveleti állapotban a művelet végrehajtódik, ellenkező esetben a memória az első bevitt szám lesz. | Művelet  végrehajtódik. Felső szövegdobozban megjelent a szám/megjelentek a számok. |  Nem találtam problémát. |
| Teszt #06 | Negáló gomb (+/-) megnyomása | Alsó szövegdobozban a szám/számok előtt megjelenik/eltűnik az előjel. | Művelet végrehajtódik. Alsó szövegdobozban megjelent/eltűnt az előjel. | Nem követi a művelet végrehajtást! Prioritás: alacsony |
